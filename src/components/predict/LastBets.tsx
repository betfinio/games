...
const LastBets: FC<{ game: Game }> = ({game}) => {
	...
	return <div className={'md:col-start-3 col-span-4 lg:col-span-2 items-center flex flex-col gap-2 lg:gap-4'}>
		{bets.length === 0 ? (<div className={'text-center text-gray-600 p-5'}>No bets yet</div>)
			: (
				<>
